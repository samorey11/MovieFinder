...
var MovieFinder = function (_React$Component) {
  ...
  _createClass(MovieFinder, [{
    ...
    value: function handleSubmit(event) {
      ...
      fetch("https://www.omdbapi.com/?s=" + search_term + "&apikey=5be4f737").then(checkStatus).then(json).then(function (data) {
    ...
    value: function render() {
      var _state = this.state,
          search_term = _state.search_term,
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          "Search one keyword from a movie title"
        ),
        React.createElement(
          "div",
          { className: "row" },
